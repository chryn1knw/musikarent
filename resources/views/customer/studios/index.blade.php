...
@section('content')
    <div class="container py-4">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <form action="{{ route('customer.studios.index') }}" method="GET" class="row g-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4 d-flex align-items-end">
                        ...
                        <a href="{{ route('customer.studios.index') }}" class="btn btn-outline-secondary">Reset</a>
                    </div>
                </form>
            </div>
        </div>
                    ...
                    <div class="card h-100 shadow-sm d-flex flex-column">
                        <div class="position-relative">
                            <img src="{{ $studio->photo_url ? asset('storage/' . $studio->photo_url) : asset('images/no-image.jpg') }}"
                                 class="card-img-top" alt="{{ $studio->name }}" style="height: 200px; object-fit: cover;">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <div class="text-muted small">
                                    <i class="bi bi-people me-1"></i>{{ $studio->capacity }} orang
                                </div>
                            </div>

                            <p class="card-text text-muted small flex-grow-1">{{ Str::limit($studio->description, 100) }}</p>
                        ...
                        <div class="card-footer bg-transparent">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span class="fw-bold text-primary flex-grow-1 text-truncate">
                                ...
                                @else
                                    <button class="btn btn-secondary btn-sm text-nowrap flex-shrink-0" disabled>
                                        <i class="bi bi-x-circle me-1"></i> Tidak Tersedia
                                    </button>
                                @endif
                            </div>
                            <div class="d-flex justify-content-between">
                                <a href="{{ route('customer.studios.show', $studio) }}" class="btn btn-sm btn-info">
            ...
            @empty
                <div class="col-12 text-center py-5">
                    <div class="d-flex flex-column align-items-center justify-content-center">
                        ...
                        <h3 class="mt-3">Belum ada data studio</h3>
                    </div>
                </div>
            @endforelse
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            @forelse($studios as $studio)
                <div class="bg-white overflow-hidden shadow-sm rounded-lg flex flex-col h-full">
                    <div class="relative">
                        <img src="{{ $studio->photo_url ? asset('storage/' . $studio->photo_url) : asset('images/no-image.jpg') }}"
                             class="w-full h-48 object-cover" alt="{{ $studio->name }}">
